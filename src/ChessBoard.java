...
public class ChessBoard {
    ...
    public boolean canCastle(Color playerColor) {
        if (playerColor == (Color.WHITE)) {
            return !whiteHasCastled && !whiteRookKingsideMoved && !whiteRookQueensideMoved;
        } else {
            return !blackHasCastled && !blackRookKingsideMoved && !blackRookQueensideMoved;
        }
    }
